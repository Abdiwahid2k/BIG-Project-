...
final int FRAME_WIDTH=325,FRAME_HEIGHT=525;  
...
digitButton[i].setForeground(Color.GREEN);  
tempX+=WIDTH+H_SPACE;  
...
operatorButton[i].setForeground(Color.ORANGE);  
...
{  
new MyCalculator("Casio FX-991EX");  
}  
}  
